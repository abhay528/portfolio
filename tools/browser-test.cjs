...
(async()=>{
 ...
 const results={scope:'Local Chromium against complete new pages. Original PDF retained on GitHub, not copied locally. No live-site or cross-browser certification.',layouts:[],checks:[]};
 const errors=[];
 for(const width of [320,390,768,1024,1440]){
  ...
  for(const file of ['index.html','vulnscan.html','page-pulse.html']){
